...
elseif($act=='register'){
	...
	//INSERT MEMBER
	$InsMember=mysql_query("INSERT INTO member (NamaLengkap,Alamat,Provinsi,Kota,LevelMember)
							VALUES('".addslashes($_POST['NamaLengkap'])."','".htmlentities($_POST['Alamat'])."','".addslashes($_POST['Provinsi'])."','".addslashes($_POST['Kota'])."','Member')");

	//CREATE ID ORDER
	$InsOrder=mysql_query("INSERT INTO OrderData(UserName,TanggalOrder)
							VALUES('".$_POST['Username']."','".date('Y-m-d')."')");
